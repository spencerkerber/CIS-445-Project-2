...
*** Decision Matrix;
array TREE2dema [2,2] _temporary_ (
/* row 1 */  14.5 0
/* row 2 */  -0.5 0
);
...
if _tarnum <= 0 then goto TREE2deex;

*** Computed Consequence of Chosen Decision;
CP_TARGET_B = TREE2dema [_tarnum,_decnum];

*** Best Possible Consequence of Any Decision without Cost;
array TREE2debe [2] _temporary_ ( 14.5 0);
BP_TARGET_B = TREE2debe [_tarnum];
